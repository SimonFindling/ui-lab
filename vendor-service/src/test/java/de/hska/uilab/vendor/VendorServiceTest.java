...
//	}
//	
//	private void writeVendorWithAddressToDB(int vendorId, String vendorName, int tenantId, String city){
...
//		assertEquals(66, retList.get(0).getTenantId());
...
//		assertEquals(66, ret.getTenantId());
//		assertEquals(1, ret.getVendorId());
...
//		
//		List<Vendor> retList = vendorRepository.findByTenantId(2);
//		assertEquals(2, retList.size());
//		assertEquals(2, retList.get(0).getTenantId());
//		assertEquals("name", retList.get(0).getName());
//		assertEquals("city", retList.get(0).getAddress().getCity());
