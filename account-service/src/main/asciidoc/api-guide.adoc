...
===== Example request
include::{snippets}/upgrade-prospect-to-customer/request-fields.adoc[]
...
===== Example request
include::{snippets}/delete-service/curl-request.adoc[]
include::{snippets}/delete-service/http-request.adoc[]

===== Example response
include::{snippets}/delete-service/http-response.adoc[]
